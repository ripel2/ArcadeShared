...
namespace acd {
    class IBlock {
        public:
             ...
             */
            virtual unique_ptr<sf::Texture> getForegroundTextureSFML() = 0;
            /**
             * @brief Get the background texture SFML
             * @return the background texture
             */
            virtual unique_ptr<sf::Texture> getBackgroundTextureSFML() = 0;
            /**
             * @brief Get the foreground texture SDL
             * @return the foreground texture
             */
            virtual unique_ptr<SDL_Texture> getForegroundTextureSDL() = 0;
            /**
             * @brief Get the background texture SDL
             * @return the background texture
             */
            virtual unique_ptr<SDL_Texture> getBackgroundTextureSDL() = 0;
            /**
